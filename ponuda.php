...
<html>
  <head>
     <title>Ponuda građevinskog materijala-Domgrad</title>
  ...
  <body>
    <div id="page-wrapper">
      ...
      <?php
      $items_query=mysqli_query($connection,'SELECT * FROM proizvod');
      while($item_row = mysqli_fetch_array($items_query))
      {
        ...
        ?>
      <div class="item">
        <div class="item-image"><img src="proizvodi/<?php echo $slika;?>" width="300" height="150" alt="<?php echo $opis; ?>" /></div>
